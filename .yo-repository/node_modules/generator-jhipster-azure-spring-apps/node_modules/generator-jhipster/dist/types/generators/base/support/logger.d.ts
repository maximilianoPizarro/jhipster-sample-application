...
import { Logger as DefaultLogger, LoggerOptions } from '@yeoman/adapter';
...
export declare const createJHipsterLogger: (options?: LoggerOptions & {
    ...
    (format?: string | undefined, parameters?: Record<string, any> | undefined): LoggerApi<import("@yeoman/types").DefaultLoggerCategories>;
