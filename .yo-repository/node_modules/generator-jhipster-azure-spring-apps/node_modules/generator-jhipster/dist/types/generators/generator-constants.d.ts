...
export const JAVA_DOCKER_DIR: "src/main/docker/";
export const LINE_LENGTH: 180;
export const CLIENT_MAIN_SRC_DIR: "src/main/webapp/";
export const CLIENT_TEST_SRC_DIR: "src/test/javascript/";
export const CLIENT_WEBPACK_DIR: "webpack/";
export const SERVER_MAIN_SRC_DIR: "src/main/java/";
...
export const PRETTIER_EXTENSIONS: "md,json,yml,html,cjs,mjs,js,cts,mts,ts,tsx,css,scss,vue,java";
