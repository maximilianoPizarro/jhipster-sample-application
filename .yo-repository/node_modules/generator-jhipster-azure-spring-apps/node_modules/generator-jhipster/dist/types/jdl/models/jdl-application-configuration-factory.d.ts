...
export declare function createApplicationNamespaceConfigurationFromObject(parsedNamespaceConfigs?: Record<string, Record<string, boolean | number | string[] | string>>): JDLApplicationConfiguration[];
