...
export default class SpringBootGenerator extends BaseApplicationGenerator {
    ...
    get composing() {
        return this.asComposingTaskGroup({
            async composing() {
                const { applicationType, databaseType, messageBroker, searchEngine, websocket, cacheProvider, skipClient, clientFramework, testFrameworks, feignClient, enableSwaggerCodegen, } = this.jhipsterConfigWithDefaults;
    ...
    get postPreparingEachEntity() {
        return this.asPostPreparingEachEntityTaskGroup({
            ...
            prepareFilters({ application, entity }) {
                entity.entityJavaFilterableProperties = [
                ...
                entity.entityJavaCustomFilters = sortedUniqBy(entity.fields.map(field => field.propertyJavaCustomFilter).filter(Boolean), 'type');
            },
        });
    }
