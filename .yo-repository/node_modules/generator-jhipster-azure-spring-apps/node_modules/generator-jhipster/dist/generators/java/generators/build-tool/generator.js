            ...
            prepareJavaApplication({ application, source }) {
                source.addJavaDependencies = (dependencies, options) => {
                    if (application.buildToolMaven) {
                        ...
                        const convertVersionToRef = ({ version, versionRef, ...artifact }) => version || versionRef ? { ...artifact, version: `\${${versionRef ?? artifact.artifactId}.version}` } : artifact;
                        const removeScope = ({ scope: _scope, ...artifact }) => artifact;
                    ...
                    if (application.buildToolGradle) {
                        ...
                        source.addGradleDependencyCatalogLibraries?.(dependencies
                            .filter(dep => dep.version || dep.versionRef)
                ...
                source.addJavaDefinition = (definition, options) => {
                    ...
                    if (dependencies) {
                        source.addJavaDependencies(dependencies.filter(dep => {
                            if (dep.versionRef) {
                ...
                source.addJavaDefinitions = (optionsOrDefinition, ...definitions) => {
                    ...
                    if ('gradleFile' in optionsOrDefinition || 'gradleVersionCatalogFile' in optionsOrDefinition) {
                        ...
                        definitions.unshift(optionsOrDefinition);
                    }
