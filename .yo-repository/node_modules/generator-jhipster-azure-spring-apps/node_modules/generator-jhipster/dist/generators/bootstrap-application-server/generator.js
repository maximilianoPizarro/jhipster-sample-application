...
import { JAVA_VERSION, MAIN_DIR, SERVER_MAIN_RES_DIR, SERVER_MAIN_SRC_DIR, SERVER_TEST_RES_DIR, SERVER_TEST_SRC_DIR, TEST_DIR, dockerContainers, } from '../generator-constants.js';
import { loadRequiredConfigIntoEntity, prepareEntityPrimaryKeyForTemplates } from '../base-application/support/index.js';
import { addEntitiesOtherRelationships, hibernateSnakeCase, loadDerivedServerConfig, loadRequiredConfigDerivedProperties, loadServerConfig, prepareEntity as prepareEntityServerForTemplates, prepareRelationship, } from '../server/support/index.js';
