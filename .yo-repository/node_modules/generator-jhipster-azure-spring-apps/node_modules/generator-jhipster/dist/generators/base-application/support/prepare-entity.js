...
import { createFaker, getMicroserviceAppName, mutateData, parseChangelog, stringHashCode, upperFirstCamelCase, } from '../../base/support/index.js';
...
export default function prepareEntity(entityWithConfig, generator, application) {
    ...
    entityWithConfig.entityTranslationKeyMenu = camelCase(entityWithConfig.clientRootFolder
...
function preparePostEntityCommonDerivedPropertiesNotTyped(entity) {
    ...
    entity.persistableOtherEntities = Object.values(relationshipsByOtherEntity).filter(relationships => relationships.some(({ persistableRelationship, otherEntity }) => persistableRelationship && otherEntity !== entity));
...
export function preparePostEntitiesCommonDerivedProperties(entities) {
    for (const entity of entities.filter(entity => !entity.dtoReferences)) {
        ...
        entity.restProperties = [
            ...entity.fields,
            ...entity.relationships.filter(relationship => relationship.persistableRelationship || relationship.relationshipEagerLoad || relationship.otherEntity.embedded),
        ];
