    ...
    configs: {
        ...
        ciCdIntegrations: {
            ...
            choices: [
                ...
                // ['github']
                {
                    name: `Would you like to enable the ${chalk.yellow('*Cypress Dashboard*')} (requires both CYPRESS_PROJECT_ID and CYPRESS_RECORD_KEY set on CI service)`,
        ...
        sonarUrl: {
            prompt: {
                when: answers => includesValue('ciCd', ['jenkins', 'github', 'gitlab', 'travis'])(answers) &&
