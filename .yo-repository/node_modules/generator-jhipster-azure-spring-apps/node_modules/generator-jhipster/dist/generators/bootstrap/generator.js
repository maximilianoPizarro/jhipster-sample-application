...
import { autoCrlfTransform, createESLintTransform, createForceWriteConfigFilesTransform, createMultiStepTransform, createPrettierTransform, createRemoveUnusedImportsTransform, createSortConfigFilesTransform, isPrettierConfigFilePath, } from './support/index.js';
...
export default class BootstrapGenerator extends BaseGenerator {
    ...
    async commitSharedFs({ log, ...options } = {}, ...transforms) {
        ...
        if (!this.skipPrettier) {
            ...
            prettierTransforms.push(createESLintTransform.call(this, { ignoreErrors }), createRemoveUnusedImportsTransform.call(this, { ignoreErrors }), await createPrettierTransform.call(this, {
                ignoreErrors,
