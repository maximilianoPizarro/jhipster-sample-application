...
import { CLIENT_WEBPACK_DIR, JAVA_COMPATIBLE_VERSIONS, JAVA_VERSION, JHIPSTER_DEPENDENCIES_VERSION, LOGIN_REGEX, MAIN_DIR, SERVER_MAIN_RES_DIR, SERVER_MAIN_SRC_DIR, SERVER_TEST_RES_DIR, SERVER_TEST_SRC_DIR, TEST_DIR, } from '../generator-constants.js';
import { applicationTypes, buildToolTypes, clientFrameworkTypes, databaseTypes, entityOptions, fieldTypes, reservedKeywords, searchEngineTypes, validations, } from '../../jdl/jhipster/index.js';
...
import { getJavaValueGeneratorForType as getJavaValueForType, getPrimaryKeyValue as getPKValue, hibernateSnakeCase, javaBeanCase as javaBeanClassNameFormat, buildJavaGet as javaGetCall, buildJavaGetter as javaGetter, buildJavaSetter as javaSetter, } from './support/index.js';
