...
import { authenticationTypes, buildToolTypes, cacheTypes, databaseTypes, monitoringTypes, searchEngineTypes, serviceDiscoveryTypes, websocketTypes, } from '../../../jdl/jhipster/index.js';
...
export const loadDerivedServerConfig = ({ application }) => {
    ...
    mutateData(application, {
        ...
        clientDistDir: ({ temporaryDir, buildToolGradle }) => `${temporaryDir}${buildToolGradle ? 'resources/main/' : 'classes/'}${CLIENT_DIST_DIR}`,
